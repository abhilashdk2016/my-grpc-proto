...
import (
	transaction_proto "github.com/abhilashdk2016/my-grpc-proto/protogen/go/transaction-proto"
...
type PaymentRequest struct {
	...
	Cart        *transaction_proto.Cart `protobuf:"bytes,1,opt,name=cart,proto3" json:"cart,omitempty"`
...
func (x *PaymentRequest) GetCart() *transaction_proto.Cart {
	if x != nil {
		return x.Cart
	}
	return nil
...
var file_proto_payment_payment_proto_rawDesc = []byte{
	...
	0x69, 0x72, 0x6d, 0x65, 0x64, 0x42, 0x43, 0x5a, 0x41, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x62, 0x68, 0x69, 0x6c, 0x61, 0x73, 0x68, 0x64, 0x6b, 0x32, 0x30,
	0x31, 0x36, 0x2f, 0x6d, 0x79, 0x2d, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x67, 0x65, 0x6e, 0x2f, 0x67, 0x6f, 0x2f, 0x70, 0x61, 0x79,
	0x6d, 0x65, 0x6e, 0x74, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_proto_payment_payment_proto_goTypes = []interface{}{
	...
	(*transaction_proto.Cart)(nil), // 2: transaction.Cart
}
